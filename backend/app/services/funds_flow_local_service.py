...
from .funds_flow_anbima_ici import FundsFlowAnbimaIciMixin
...
class FundsFlowLocalService(
    FundsFlowAnalyticsMixin, FundsFlowAnbimaIciMixin, FundsFlowCftcMixin
):
