...
验证：
1. Twitter Profile 生成 OASIS 当前使用的 CSV 格式
2. Reddit Profile 生成 OASIS 当前使用的 JSON 格式
"""
...
def show_expected_formats():
    """显示OASIS期望的格式"""
    print("\n" + "=" * 60)
    print("OASIS 当前Profile格式参考")
    print("=" * 60)
    
    print("\n1. Twitter Profile (CSV格式)")
    print("-" * 40)
    twitter_example = """user_id,name,username,user_char,description
0,User Zero,user0,I am user zero with interests in technology. User Zero is active in public discussion.,I am user zero with interests in technology.
1,User One,user1,Tech enthusiast and coffee lover. User One reacts quickly to social topics.,Tech enthusiast and coffee lover."""
